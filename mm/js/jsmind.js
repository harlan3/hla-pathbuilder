...
; (function ($w) {
    ...
    jm.mind.prototype = {
        ...
        add_node: function (parent_node, nodeid, topic, link, data, idx, direction, expanded) {
            if (!jm.util.is_node(parent_node)) {
                ...
                if (!the_parent_node) {
                    ...
                    return this.add_node(the_parent_node, nodeid, topic, link, data, idx, direction, expanded);
                }
            }
            var nodeindex = idx || -1;
            var node = null;
            if (parent_node.isroot) {
                ...
                node = new jm.node(nodeid, nodeindex, topic, link, data, false, parent_node, d, expanded);
            } else {
                node = new jm.node(nodeid, nodeindex, topic, link, data, false, parent_node, parent_node.direction, expanded);
            }
        ...
        insert_node_before: function (node_before, nodeid, topic, data) {
            ...
            return this.add_node(node_before.parent, nodeid, topic, link, data, node_index);
        },
        ...
        insert_node_after: function (node_after, nodeid, topic, data) {
            ...
            return this.add_node(node_after.parent, nodeid, topic, link, data, node_index);
        },
    ...
    jm.format = {
        node_tree: {
            example: {
                ...
                "format": "node_tree",
                "data": { "id": "root", "topic": "Select Model to Load" }
            },
            ...
            _extract_subnode: function (mind, node_parent, node_json) {
                ...
                var node = mind.add_node(node_parent, node_json.id, node_json.topic, node_json.link, data, null, d, node_json.expanded);
        ...
        node_array: {
            example: {
                ...
                "format": "node_array",
                "data": [
                    { "id": "root", "topic": "Select Model to Load", "isroot": true }
                ]
            },
            ...
            _extract_root: function (mind, node_array) {
                ...
                while (i--) {
                    if ('isroot' in node_array[i] && node_array[i].isroot) {
                        ...
                        mind.set_root(root_json.id, root_json.topic, root_json.link, data);
            ...
            _extract_subnode: function (mind, parentid, node_array) {
                ...
                while (i--) {
                    ...
                    if (node_json.parentid == parentid) {
                        ...
                        mind.add_node(parentid, node_json.id, node_json.topic, node_json.link, data, null, d, node_json.expanded);
                        node_array.splice(i, 1);
                        extract_count++;
        ...
        freemind: {
            ...
            _load_node: function (mind, parent_id, xml_node) {
                ...
                if (!!parent_id) {
                    mind.add_node(parent_id, node_id, node_topic, node_link, node_data, null, node_direction, node_expanded);
                } else {
                    mind.set_root(node_id, node_topic, node_link, node_data);
                }
    ...
    jm.prototype = {
        ...
        add_node: function (parent_node, nodeid, topic, link, data) {
            if (this.get_editable()) {
                var node = this.mind.add_node(parent_node, nodeid, topic, link, data);
                if (!!node) {
                    ...
                    this.invoke_event_handle(jm.event_type.edit, { evt: 'add_node', data: [parent_node.id, nodeid, topic, link, data], node: nodeid });
                }
                return node;
            } else {
                logger.error('fail, this mind map is not editable');
